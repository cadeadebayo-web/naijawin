        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-16 md:grid-cols-[1.02fr_0.98fr] md:py-24">
          ...
          {featuredCompetition ? (
            <div className="relative z-10 order-1 rounded-[2rem] border border-white/10 bg-white/10 p-3 shadow-2xl backdrop-blur-sm md:order-2">
              <div className="relative min-h-[535px] overflow-hidden rounded-[1.75rem] bg-[linear-gradient(145deg,#063629_0%,#052E24_58%,#0A4535_100%)] p-5 md:min-h-[510px] md:p-6">
                ...
                <div className="absolute inset-x-5 bottom-5 top-20 z-20 overflow-hidden rounded-[1.6rem] border border-white/15 bg-[#052E24]/25 shadow-[0_28px_90px_rgba(0,0,0,0.3)] md:inset-x-6 md:bottom-6 md:top-20">
                  <div className="naijawin-feature-car-panel absolute inset-0">
                    ...
                    <div className="naijawin-car-splash absolute inset-x-[-10%] bottom-20 top-8 md:inset-x-[-22%] md:bottom-2 md:top-0">
                      <Image
                        src={
                    ...
                    <div className="absolute bottom-5 left-5 right-5 z-20 flex justify-center md:hidden">
                      <div className="rounded-full bg-[#D6A84F] px-5 py-3 text-center text-xs font-black uppercase tracking-[0.22em] text-[#052E24] shadow-[0_18px_40px_rgba(214,168,79,0.24)]">
                        Your Chance To Win
                      </div>
                    </div>
                  </div>
